...
function PeuplementContrats()
{
    ...
    function displayContracts(contracts)
    {
        contracts.forEach(contract => {
            ...
            // CrÈez le bouton pour ouvrir le PDF dans une nouvelle fenÍtre
            ...
            // Ajoutez le bouton aprËs l'iframe
            ...
            // Ajoutez la ligne de contrat ‡ la div 'contenu'
...
async function populateTitreDropdown() {
    try {
        ...
        titres.forEach(titre => {
            ...
            option.value = titre.id_titre; // Utilisez l'id de la fonction des employÈs comme valeur
            option.text = titre.nomTitre; // Utilisez le nom de la fonction des employÈs comme texte

...
const urlVilles = 'http://api.geonames.org/searchJSON?country=FR&featureClass=P&maxRows=1000&username=mathieusoleri';
...
async function populateCityDropdown(countryCode) {
    try {
        const response = await fetch('http://api.geonames.org/searchJSON?country='+countryCode+'&featureClass=P&maxRows=1000&username=mathieusoleri');
